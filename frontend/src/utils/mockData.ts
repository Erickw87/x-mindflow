...
export function generateMockTopologyData(): TopologyData {
  ...
  const edges: TopologyData['edges'] = [
    ...
    { id: 'hidden-1', source: 'lb-entry', target: 'entry', trafficPercentage: 0, hidden: true },
    { id: 'hidden-2', source: 'lb-a-branch1', target: 'service-a-branch1', trafficPercentage: 0, hidden: true },
    { id: 'hidden-3', source: 'lb-a-branch2', target: 'service-a-branch2', trafficPercentage: 0, hidden: true },
    { id: 'hidden-4', source: 'lb-b-branch1', target: 'service-b-branch1', trafficPercentage: 0, hidden: true },
    { id: 'hidden-5', source: 'lb-b-branch2', target: 'service-b-branch2', trafficPercentage: 0, hidden: true },
    { id: 'hidden-6', source: 'lb-c', target: 'service-c', trafficPercentage: 0, hidden: true },
